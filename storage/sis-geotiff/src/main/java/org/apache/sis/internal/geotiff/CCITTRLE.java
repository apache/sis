...
final class CCITTRLE extends InflaterChannel {
     ...
     */
    CCITTRLE(final ChannelDataInput input, final long start, final long byteCount, final int sourceWidth) throws IOException {
        super(input, start, byteCount);
        remainingBitsInRow = bitsPerRow = sourceWidth;
    }
