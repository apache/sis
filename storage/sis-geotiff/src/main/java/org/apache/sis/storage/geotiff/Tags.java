...
/**
 * Numerical values of GeoTIFF tags. In this class, field names are identical to
 * TIFF tag names. For that reason, many of those field names do not follow
 * usual Java convention for constants.
 *
 * <p>
 * A useful (but unofficial) reference is the
...
final class Tags {
     ...
     * inefficient, but it should rarely be invoked (mostly for formatting error
     * messages).
     */
