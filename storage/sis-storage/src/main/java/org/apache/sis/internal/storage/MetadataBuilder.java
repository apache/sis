...
parse:      for (int i = 0; i < length;) {
            ...
            if (i != 0) {
                ...
                final DefaultResponsibleParty p = new DefaultResponsibleParty(Role.OWNER);
                p.setParties(Collections.singleton(party));
                c.setCitedResponsibleParties(Collections.singleton(p));
            }
