...
public final class R2SonicSpecific extends StructClass {
    public static final GroupLayout LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(6, GSF.C_DOUBLE).withName("A0_more_info"),
        MemoryLayout.sequenceLayout(6, GSF.C_DOUBLE).withName("A2_more_info"),
        GSF.C_DOUBLE.withName("G0_depth_gate_min"),
        GSF.C_DOUBLE.withName("G0_depth_gate_max"),
        GSF.C_DOUBLE.withName("G0_depth_gate_slope"),
