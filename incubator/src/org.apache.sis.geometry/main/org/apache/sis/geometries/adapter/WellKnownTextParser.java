...
final class WellKnownTextParser {
    ...
    private CoordinateReferenceSystem crs() {
        ...
        if (srid != Srid.UNDEFINED) {
             ...
             * adding an ellipsoidal height to a two-dimensional one if the text has a Z ordinate.
             * The dimension is therefore part of the cache key: an EMPTY element may ask for one
