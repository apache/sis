...
/**
 * Tests the {@code locateAlong} operations of {@link GeometryProcessor}.
 *
 * @author Johann Sorel (Geomatys)
 */
public class LocateAlongTest {
    /**
     * The inputs and expected result of a single test of {@code locateAlong(Geometry, double)}.
     *
     * @param input    the geometry on which the operation is invoked.
     * @param mValue   the measure value to locate.
    ...
    /**
     * Tests {@code locateAlong(Geometry, double)} on all declared test cases.
     */
    @Test
