...
/**
 * Tests the {@code disjoint} operations of {@link GeometryProcessor}.
 *
...
public class DisjointTest {
    ...
    /**
     * All test cases of {@code disjoint(Geometry, Geometry)}.
     */
    ...
    /**
     * Tests {@code disjoint(Geometry, Geometry)} on all declared test cases.
     */
    @Test
    public void testDisjoint() {
        for (final TestCase entry : ENTRIES) {
            try {
                final boolean result = new GeometryProcessor().disjoint(entry.input(), entry.other());
