...
/**
 * Tests the {@code equal} operations of {@link GeometryProcessor}.
 *
...
public class EqualTest {
    ...
    /**
     * All test cases of {@code equal(Geometry, Geometry)}.
     */
    ...
    /**
     * Tests {@code equal(Geometry, Geometry)} on all declared test cases.
     */
    @Test
    public void testEqual() {
        for (final TestCase entry : ENTRIES) {
            try {
                final boolean result = new GeometryProcessor().equal(entry.input(), entry.other());
