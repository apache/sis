...
public final class MD_BrowseGraphic extends PropertyType<MD_BrowseGraphic, BrowseGraphic> {
     ...
     */
    private MD_BrowseGraphic(final BrowseGraphic value) {
        super(value);
    }
     ...
     * inside the {@code <mcc:MD_BrowseGraphic>} XML element.
     ...
     */
    public void setElement(final DefaultBrowseGraphic value) {
        metadata = value;
    }
}
