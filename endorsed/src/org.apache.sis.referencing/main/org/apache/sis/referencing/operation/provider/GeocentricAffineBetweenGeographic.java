...
public abstract class GeocentricAffineBetweenGeographic extends GeocentricAffine {
     ...
     * If we want to provide a default value, we could but it would complicate a little bit the code because
     * we could no longer reuse the same {@code PARAMETERS} constant for all operation methods.</p>
     *
