...
public final class CoordinateFrameRotation3D extends GeocentricAffineBetweenGeographic {
     ...
     * @see #provider()
     */
    private static final CoordinateFrameRotation3D INSTANCE = new CoordinateFrameRotation3D();
     ...
     */
    public static CoordinateFrameRotation3D provider() {
        return INSTANCE;
    }
    ...
    public CoordinateFrameRotation3D() {
        super(Type.FRAME_ROTATION, PARAMETERS, (byte) 3);
    }
    ...
    public AbstractProvider variantFor(final MathTransform transform) {
        return maxDimension(transform) < 3 ? CoordinateFrameRotation2D.provider() : this;
    }
}
