...
public class FeatureProjection implements UnaryOperator<Feature> {
     ...
     */
    public static FeatureProjection create(final FeatureType sourceType, final FeatureQuery.NamedExpression[] projection) {
        if (projection != null) {
     ...
     *         It may be because that expression is backed by an unsupported implementation.
     */
    protected FeatureProjection(final FeatureType sourceType, final FeatureQuery.NamedExpression[] projection) {
        int storedCount   = 0;
...
isIdentity: if (propertiesOfIdentity != null) {
    ...
    public FeatureProjection(final FeatureType type, final Map<String, Expression<? super Feature, ?>> projection) {
        featureType = type;
     ...
     */
    private static String reference(final Expression<? super Feature, ?> expression, final boolean decode) {
