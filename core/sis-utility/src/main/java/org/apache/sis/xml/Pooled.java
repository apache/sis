...
abstract class Pooled {
     ...
     * then the output generated by JAXB will need to go through a {@link FilteredWriter} in order to
     * replace the namespace of versions implemented by SIS by the namespace of versions requested by
     * the user.
     *
