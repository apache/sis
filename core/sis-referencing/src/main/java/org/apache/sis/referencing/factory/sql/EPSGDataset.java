 ...
 * If there is no cached object for a given code, then {@code EPSGDataset} creates an {@link EPSGFactory} instance for
 * performing the actual creation work. Developers who need to customize the geodetic object creation can override the
 * {@link #createBackingStore(Connection)} method in order to return their own {@link EPSGFactory} subclass.
 *
 ...
 * @module
 */
public class EPSGDataset extends ConcurrentAuthorityFactory implements CRSAuthorityFactory,
        CSAuthorityFactory, DatumAuthorityFactory, CoordinateOperationAuthorityFactory, Localized
{
     ...
     */
    public EPSGDataset() throws FactoryException {
     ...
     */
    public EPSGDataset(final DataSource                 dataSource,
    ...
    protected final GeodeticAuthorityFactory createBackingStore() throws FactoryException {
        ...
        try {
            ...
            final EPSGFactory factory = createBackingStore(c);
     ...
     *
     * <p>The default implementation creates a new {@link EPSGFactory} instance.
     ...
     * @throws SQLException if {@code EPSGFactory} detected a problem with the database.
     * @return The backing store to use in {@code createFoo(String)} methods.
     */
    protected EPSGFactory createBackingStore(final Connection connection) throws SQLException {
        return new EPSGFactory(connection, nameFactory, datumFactory, csFactory, crsFactory, copFactory, mtFactory);
    }
}
