...
public final strictfp class MetadataUtilitiesTest extends TestCase {
    ...
    public void testSetBoolean() {
        ...
        int flags = 0;
        flags = MetadataUtilities.setBoolean(flags, mask1, null ); assertEquals(0b000000, flags);
        flags = MetadataUtilities.setBoolean(flags, mask1, TRUE ); assertEquals(0b001100, flags);
        flags = MetadataUtilities.setBoolean(flags, mask2, FALSE); assertEquals(0b101100, flags);
        flags = MetadataUtilities.setBoolean(flags, mask1, null ); assertEquals(0b100000, flags);
        flags = MetadataUtilities.setBoolean(flags, mask0, TRUE ); assertEquals(0b100011, flags);
        flags = MetadataUtilities.setBoolean(flags, mask0, FALSE); assertEquals(0b100010, flags);
    }
}
