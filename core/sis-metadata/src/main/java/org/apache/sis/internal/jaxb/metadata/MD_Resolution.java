...
public final class MD_Resolution extends PropertyType<MD_Resolution, Resolution> {
     ...
     * in a {@code <gmd:MD_Resolution>} XML element.
     *
     * @param  metadata The metadata element to marshall.
     * @return A {@code PropertyType} wrapping the given the metadata element.
     */
    @Override
    protected MD_Resolution wrap(final Resolution metadata) {
        return new MD_Resolution(metadata);
    }

    /**
     * Invoked by JAXB at marshalling time for getting the actual metadata to write
     * inside the {@code <gmd:MD_Resolution>} XML element.
