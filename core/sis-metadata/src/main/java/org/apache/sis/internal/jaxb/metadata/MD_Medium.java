...
public final class MD_Medium extends PropertyType<MD_Medium, Medium> {
     ...
     * in a {@code <gmd:MD_Medium>} XML element.
     *
     * @param  metadata The metadata element to marshall.
     * @return A {@code PropertyType} wrapping the given the metadata element.
     */
    @Override
    protected MD_Medium wrap(final Medium metadata) {
        return new MD_Medium(metadata);
    }

    /**
     * Invoked by JAXB at marshalling time for getting the actual metadata to write
     * inside the {@code <gmd:MD_Medium>} XML element.
