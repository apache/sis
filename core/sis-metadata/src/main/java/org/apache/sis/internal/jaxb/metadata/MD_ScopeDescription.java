...
public final class MD_ScopeDescription extends PropertyType<MD_ScopeDescription, ScopeDescription> {
     ...
     * in a {@code <gmd:MD_ScopeDescription>} XML element.
     *
     * @param  metadata The metadata element to marshall.
     * @return A {@code PropertyType} wrapping the given the metadata element.
     */
    @Override
    protected MD_ScopeDescription wrap(final ScopeDescription metadata) {
        return new MD_ScopeDescription(metadata);
    }

    /**
     * Invoked by JAXB at marshalling time for getting the actual metadata to write
     * inside the {@code <gmd:MD_ScopeDescription>} XML element.
