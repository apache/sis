...
/**
 * JAXB adapter for {@link MediumFormat}
...
public final class MD_MediumFormatCode extends CodeListAdapter<MD_MediumFormatCode, MediumFormat> {
     ...
     */
    private MD_MediumFormatCode(final CodeListUID value) {
        super(value);
    }
     ...
     */
    @Override
    protected MD_MediumFormatCode wrap(final CodeListUID value) {
        return new MD_MediumFormatCode(value);
    }
