...
public final class DQ_Result extends PropertyType<DQ_Result, Result> {
     ...
     * in a {@code <gmd:DQ_Result>} XML element.
     *
     * @param  metadata The metadata element to marshall.
     * @return A {@code PropertyType} wrapping the given the metadata element.
     */
    @Override
    protected DQ_Result wrap(final Result metadata) {
        return new DQ_Result(metadata);
    }

    /**
     * Invoked by JAXB at marshalling time for getting the actual metadata to write
     * inside the {@code <gmd:DQ_Result>} XML element.
