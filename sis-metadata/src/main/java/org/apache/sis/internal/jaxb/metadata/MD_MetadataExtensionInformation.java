 ...
 * @module
 */
public final class MD_MetadataExtensionInformation extends
        PropertyType<MD_MetadataExtensionInformation, MetadataExtensionInformation>
{
    /**
     ...
     * in a {@code <gmd:MD_MetadataExtensionInformation>} XML element.
     *
     * @param  metadata The metadata element to marshall.
     * @return A {@code PropertyType} wrapping the given the metadata element.
     */
    @Override
    protected MD_MetadataExtensionInformation wrap(final MetadataExtensionInformation metadata) {
        return new MD_MetadataExtensionInformation(metadata);
    }

    /**
     * Invoked by JAXB at marshalling time for getting the actual metadata to write
     * inside the {@code <gmd:MD_MetadataExtensionInformation>} XML element.
