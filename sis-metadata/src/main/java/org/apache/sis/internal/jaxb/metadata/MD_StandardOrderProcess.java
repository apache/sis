 ...
 * @module
 */
public final class MD_StandardOrderProcess extends
        PropertyType<MD_StandardOrderProcess, StandardOrderProcess>
{
    /**
     ...
     * in a {@code <gmd:MD_StandardOrderProcess>} XML element.
     *
     ...
     * inside the {@code <gmd:MD_StandardOrderProcess>} XML element.
